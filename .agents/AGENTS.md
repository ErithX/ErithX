...
- Whenever we implement a major architectural decision, complex logic, or solve a difficult trade-off (a "critical task"), you MUST automatically document the decision, rationale, and implementation details in `challengs.txt` located at the root of the project. But never update Frontend related tasks without asking owner , Only update backend decisions which are critical without any permission
