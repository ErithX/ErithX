        ...
        <div className="space-y-20">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center scroll-reveal">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-sm text-zinc-400 leading-relaxed mb-6">
                In your first years, you need generic study materials that don&apos;t suck. We give you instant access to the best PDF notes, so you can ace academics while saving time for actual coding.
              </p>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="text-sm font-medium">B.Tech Free PDFs</div>
                    <div className="text-xs text-zinc-500">Download high-quality notes for fundamental subjects like OS, DBMS, and Networks.</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-md bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    <div className="text-sm font-medium">Verified PYQs</div>
                    <div className="text-xs text-zinc-500">Don&apos;t guess what&apos;s on the semester exam. Use our archive of previous year question papers.</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-md bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-zinc-500">Understand the real tech landscape early without the overwhelming noise.</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center scroll-reveal">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 glass rounded-xl p-4 float-anim-delay hidden md:block">
                ...
                <div className="text-[10px] text-zinc-500">Market Relevant</div>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center scroll-reveal">
            <div className="relative order-2 lg:order-1">
              ...
              <div className="absolute -bottom-6 -right-6 glass rounded-xl p-4 float-anim hidden md:block">
                <div className="text-2xl font-semibold text-purple-400">30+</div>
                <div className="text-[10px] text-zinc-500">Contests Tracked</div>
              </div>
            </div>
            <div className="order-1 lg:order-2">
