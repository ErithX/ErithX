...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: '2026 SDE Resources That Actually Get You Hired | ErithX',
    description: 'Skip generic CS notes. Master what gets you hired in 2026: modern System Design, advanced backend architectures, and the real truth about DSA in the AI era.',
    url: `${process.env.NEXT_PUBLIC_NEW_DOMAIN}/resources`,
    type: 'website',
  },
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_NEW_DOMAIN}/resources`,
  },
};
